  ...
  if (!opcao) {
    ...
    switch (opcao) {
      case 1:
        if (!verificar()) {
          if (!livros.nome) {
            ...
            } else console.log("Número de páginas inválidas.");
          } else if (!livros.autor) {
            if (entrada_usuario.length > 3) {
              livros.autor = entrada_usuario;
              console.log("Digite o Gênero");
            } else console.log("Nome do autor inválido");
          } else {
            if (entrada_usuario.length > 3) {
              ...
              mensagem();
            } else console.log("Gênero inválido");
          }
        }
        break;
      ...
      case 2:
        ...
        } else console.log("Sem nenhum livro adicionado até o momento \n");
        opcao = 0;
        mensagem();
      ...
      case 3:
        ...
        } else console.log("Nenhum livro na lista. \n");
        opcao = 0;
        mensagem();
        break;
